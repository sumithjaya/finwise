...
const ADVISERS: Adviser[] = [
  {
    ...
    city: "Sydney",
    state: "NSW",
    img: "/images/adviser01.jpg",
  },
  {
    name: "Oliver Kent",
    dept: "Retirement Planning",
    city: "Melbourne",
    state: "VIC",
    img: "/images/adviser02.jpg",
  },
  {
    name: "Maya Singh",
    dept: "Superannuation",
  ...
  },
  {
    ...
    city: "Perth",
    state: "WA",
    img: "/images/adviser04.jpg",
  },
  {
    name: "Sophia Lee",
    dept: "Estate Planning",
    city: "Adelaide",
    state: "SA",
    img: "/images/adviser01.jpg",
  },
    ...
    <div className={styles.wrapper_container}>
      <div className={styles.wrapper}>
        <div className={styles.header}>
          ...
          <p>
            Connect with top financial advisers in Australia and get the
            guidance you need to build a secure financial future.
          </p>
        </div>
